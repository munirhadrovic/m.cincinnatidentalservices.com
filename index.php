...
<html>
	<head>
		<title>Dentists-Oral Surgery-Cincinnati Dental Services-Cincinnati</title>
	...
	<body>
        ...
        <div data-role="footer" data-theme="<?php echo $theme ?>" data-position="fixed">
            <h1 style="font-weight: normal; font-size: 13px;">Powered By <a href="http://mobilegrows.com/" rel="external" style="text-decoration: none;">MobileGrows</a> | <a href="http://www.cincinnatidentalservices.com/ rel="external" style="text-decoration: none;">  Desktop Site</a></h1>
        </div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
              ...
              <fieldset class="ui-grid-a" data-theme="<?php echo $theme ?>">
                  ...
                  <div class="ui-block-a">
                      ...
                      <a class="ui-btn ui-icon-phone ui-btn-icon-left two-button" href="#myPopuptelephone" data-rel="popup" data-transition="flow">Call US</a>
                  ...
                  <div class="ui-block-b" id="findUS">
                      ...
                      <a class="ui-btn ui-icon-location ui-btn-icon-right two-button" href="#myPopup" data-rel="popup" data-transition="flow">Find US</a>
              ...
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Services</a>
                  </div>
              </div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
              ...
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Privacy Practices</a>
                  </div>
              </div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
              ...
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Post Treatment</a>
                  </div>
              </div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
		...
		<div data-role="page" id="page2" data-theme="<?php echo $theme ?>">
			<div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                    ...
                    <p class="page_paraf">This is only a <b>Preview</b> version of your Mobile Website.<br><br>
